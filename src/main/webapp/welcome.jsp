...
<body>
<script src="${APP_PATH}/static/js/three.min.js"></script>
<div id="world"></div>
<div style="height: 100vh">
    ...
    <div>
        ...
        <div style="position: absolute;z-index: 100">
            ...
            <div>
                <c:if test="${username==null}" var="guest">
                    <h1 align="center" style="margin-left: 600px;">java在线考试系统</h1></div>
                </c:if>
                <c:if test="${not guest}">
                    <h1 align="center" style="margin-left: 550px;">欢迎来到java在线考试系统</h1></div>
                </c:if>
            <br><br><br>
            <div>
                <div class="container" style="margin-left: 10px;width: 250px">
                    <!--    手风琴样式-->
                    <div class="panel-group" id="accordion" role="tablist">
                        <div class="panel panel-info ">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">考试内容</a>
                                </h4>
                            </div>
                        ...
                        <div class="panel panel-success">
                            <div class="panel-heading" role="tab" id="headingTwo">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">考试要求</a>
                                </h4>
                            </div>
                            <div id="collapseTwo" class="panel-collapse collapse " role="tabpanel">
                                <div class="panel-body">
                                    Q:如何参加在线考试?<br>
                                    A:注册一个帐号，然后就可以练习，点击问题列表可以看到正在进行的问题并参加。
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-warning">
                            <div class="panel-heading" role="tab" id="headingThree">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree">考试纪律</a>
                                </h4>
                            </div>
                            <div id="collapseThree" class="panel-collapse collapse " role="tabpanel">
                                <div class="panel-body">
                                    1．学生必须按考试日程表指定时间、地点参加考试并提前15分钟进入考场，按规定座位号就座，迟到30分钟以上者，不准进入考场。<br>
                                    2．学生参加考试必须携带校园一卡通或身份证，否则不具备考试资格。<br>
                                    3．考生在考场内必须保持安静，严格遵守考场纪律。
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input id="myModelName" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label class="control-label">密码 </label>
                                <input id="myModelPwd" type="password" class="form-control">
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" id="updateUserBtn" class="btn btn-primary">
                            保存
                        </button>
                    </div>
                </div>
...
<script>
    ...
    $("#myModal").on("shown.bs.modal", function (e) {
        ...
        var userName="";
        $.ajax({
            url:"${APP_PATH}/register/getUserName",
            data:"userId="+recipient,
            type:"post",
            success:function (result) {
                console.log(result.code);
                userName = result.extend.userName;
                modal.find(".modal-title").text("Hello " + recipient);
                modal.find(".modal-body  #myModelName").val(userName);//给两个弹出的输入框注入初值
            }
        });
    });
    $("#myModal").modal({
    ...
    $("#updateUserBtn").on('click',function () {
        var msg1 = $("#myModelName").val();
        var msg2 = $("#myModelPwd").val();
        $.ajax({
            url:"${APP_PATH}/register/updateUser",
            data:"userName="+msg1+"&password="+msg2,
            type:"post",
            success:function (result) {
                if (result.code==100) {
                    alert("修改成功");
